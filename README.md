...
- [Requisitos do projeto](#requisitos-do-projeto)
  ...
  - [Lista de requisitos](#lista-de-requisitos)
    - [1 - Configure um `BrowserRouter` dentro do componente `App`](#1---configure-um-browserrouter-dentro-do-componente-app)
    ...
    - [4 - Crie um componente chamado `MovieDetails`](#4---crie-um-componente-chamado-moviedetails)
  - [Para os requisitos 5 e 6](#para-os-requisitos-5-e-6)
    - [5 - Crie um componente chamado `EditMovie`](#5---crie-um-componente-chamado-editmovie)
    - [6 - Crie um componente chamado `NewMovie`](#6---crie-um-componente-chamado-newmovie)
